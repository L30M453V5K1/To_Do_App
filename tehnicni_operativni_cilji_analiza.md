...
V tej nalogi sem izvedel analizo kakovosti kode v svojem Spring Boot backend projektu. Za merjenje metrik sem uporabil IntelliJ vtičnik Metrics Reloaded, ki izračuna različne objektno usmerjene metrike, kot so CBO, DIT, LCOM, NOC, RFC in WMC.

Na podlagi dobljenih rezultatov sem določil tri cilje: en tehnični in dva operativna. Za vsak cilj sem pripravil vprašanje, metrike in razlago, kako sem analiziral trenutno stanje ter kako bi lahko spremljal izboljšave.
...
Na podlagi metrik sem določil tri ključne cilje za izboljšanje kakovosti kode:
